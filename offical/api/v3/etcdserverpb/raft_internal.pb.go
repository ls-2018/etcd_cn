...
func (m *InternalRaftRequest) Marshal() (dAtA []byte, err error)         { return json.Marshal(m) }
...
func (m *InternalRaftRequest) Unmarshal(dAtA []byte) error         { return json.Unmarshal(dAtA, m) }
