...
```bash
go get github.com/ls-2018/etcd_cn/offical/client/v3
```
...
```
go get github.com/ls-2018/etcd_cn/offical/client/v3@v3.5.0-pre
```
...
The [namespace](https://godoc.org/github.com/ls-2018/etcd_cn/offical/client/v3/namespace) package provides `clientv3` interface wrappers to transparently isolate client requests to a user-defined prefix.
...
More code [examples](https://github.com/etcd-io/etcd/tree/main/tests/integration/clientv3/examples) can be found at [GoDoc](https://pkg.go.dev/github.com/ls-2018/etcd_cn/offical/client/v3).
