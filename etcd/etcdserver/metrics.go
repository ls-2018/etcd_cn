...
import (
	...
	"github.com/ls-2018/pkg/runtime"
...
var (
	...
	applySnapshotInProgress = prometheus.NewGauge(prometheus.GaugeOpts{
		...
		Help:      "1 if the etcd is applying the incoming snapshot. 0 if none.",
	})
	...
	currentGoVersion = prometheus.NewGaugeVec(prometheus.GaugeOpts{
		...
		Subsystem: "etcd",
		Name:      "go_version",
		Help:      "Which Go version etcd is running with. 1 for 'server_go_version' label with current version.",
	},
