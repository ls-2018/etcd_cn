...
type Config struct {
	...
	// wait before pinging etcd. When client pings "too fast", etcd
	...
	// GRPCKeepAliveInterval is the frequency of etcd-to-client ping
	...
	// other address). Then, all HTTP endpoints of etcd etcd listening
