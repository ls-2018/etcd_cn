...
const (
	jwtRSAPubKey  = "../../tests/fixtures/etcd.crt"
	jwtRSAPrivKey = "../../tests/fixtures/etcd.key.insecure"

	jwtECPubKey  = "../../tests/fixtures/etcd-ecdsa.crt"
	jwtECPrivKey = "../../tests/fixtures/etcd-ecdsa.key.insecure"
)
